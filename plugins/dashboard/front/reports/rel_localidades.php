...
if($status == $status_closed ) {
	...
	if($barra < 0) { $cor = "progress-bar-danger"; $barra = 0; }
		...
		echo "
		<tr>
			<td style='vertical-align:middle; text-align:left;'><a href='rel_localidade.php?con=1&grp=". $id_loc['id'] ."&date1=".$data_ini."&date2=".$data_fin."' target='_blank' >" . $id_loc['name'].' ('.$id_loc['id'].")</a></td>
        ...
        "sDom": 'T<"clear">lfrtip',
         ...
         "aButtons": [
             ...
             },
             {
                 ...
                 "sPdfMessage": "<?php echo  __('Period','dashboard'); ?> : <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?>"
                  } ]
             }
         ]
        }
