		...
		<div id="charts" class="row-fluid chart">
			<div id="pad-wrapper" >
				...
				<div id="head-rel" class="row-fluid">
					...
					<div id="titulo_graf"> <?php echo __('Summary Report','dashboard') ." - ". __('Technician') ?> </div>		
...
SELECT count(glpi_tickets.id) AS conta, glpi_users.firstname AS name, glpi_users.realname AS sname
			...
			AND glpi_tickets.users_id_lastupdater = 1005
...
$content = "
		<div class='well info_box row-fluid col-md-12 report' style='margin-left: -1px; margin-top:-50px;'>	
 			<div class='right'> <button class='btn btn-primary btn-sm' type='button' onclick=window.open(\"./rel_sint_tec_pdf.php?con=1&date1=".$data_ini2."&date2=".$data_fin2."&sel_tec=".$id_tec."\",\"_blank\")>Export PDF</button>  </div>	
...
$content .= "					
			 ...
			 <table class='row-fluid table table-striped table-condensed'  style='font-size: 16px; width:55%; margin:auto; margin-bottom:25px;'>
			 <thead>
			 <tr>
