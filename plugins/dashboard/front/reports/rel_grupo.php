         ...
         "sRowSelect": "os",
          ...
          },
          {
          ...
          },
	       {
	           ...
	           "sPdfMessage": "<?php echo __('Group'); ?> : <?php echo $grp_name['name'] .'  -  '; ?> <?php echo  __('Tickets','dashboard'); ?> : <?php echo $consulta .'  -  '; ?><?php echo  __('Period','dashboard'); ?> : <?php echo conv_data($data_ini2); ?> a <?php echo conv_data($data_fin2); ?> ",
	            } ]
	       } ]
        }
