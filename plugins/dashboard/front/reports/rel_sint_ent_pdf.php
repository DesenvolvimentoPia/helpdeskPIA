...
<page backtop='5mm' backbottom='5mm' backleft='15mm' backright='10mm'> 
      ...
      <page_footer align='center'>
 		...
 		<!-- <div class='row-fluid col-md-12 report' style='margin-left: 0px; margin-top: -8px;'> -->		
...
$content .= "					
			 ...
			 <table class='row-fluid table table-striped table-condensed'  style='font-size: 16px; width:85%; margin:auto;'>
			 <thead>
			 <tr>
			 ...
			 <table class='row-fluid table table-striped table-condensed'  style='font-size: 16px; width:55%; margin:auto;'>
			 <thead>
			 <tr>
			 ...
			 <table class='row-fluid table table-striped table-condensed'  style='font-size: 16px;  margin:auto;'>
			 <thead>
			 <tr>
