		...
		<div id="charts" class="row-fluid chart">
			<div id="pad-wrapper" >			
				<div id="head-rel" class="row-fluid">				
					...
					<div id="titulo_graf"> <?php echo __('Summary Report','dashboard') .' - ' .__('Entity'); ?> </div>		
...
$content = "
		<div class='well info_box row-fluid col-md-12 report' style='margin-left: -1px; margin-top:-50px;'>	
 			<div class='right'> <button class='btn btn-primary btn-sm' type='button' onclick=window.open(\"rel_sint_ent_pdf.php?con=1&date1=".$data_ini2."&date2=".$data_fin2."&sel_ent=".$id_ent."\",\"_blank\")>Export PDF</button>  </div>	
