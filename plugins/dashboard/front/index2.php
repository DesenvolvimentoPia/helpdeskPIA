                                    ...
                                    <a class='dropdown' onClick='return false;' href='#' data-original-title='Relatórios'>
                                        ...
                                        <span class='hidden-minibar'><?php echo __('Reports','dashboard'); //<b class="caret"></b>?>
                                            <i class='fa fa-chevron-right  pull-right'></i>
													...
													<ul  class="animated fadeInDown">
													<li class=' '>
                                            <a href="./reports/rel_sint.php" data-original-title=' Sintético' target="_blank">
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('Summary','dashboard'); ?> </span>
                                            </a>
                                        </li>
													<li class=' '>
                                       ...
                                       <li class=' '>
                                        ...
                                        <li class=' '>
	                                           <a href="./reports/rel_localidades.php?con=1" data-original-title=' Location' target="_blank">
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('Location'); ?></span>
                                            </a>
                                        </li>
                                        <li class=' '>
	                                           <a href="./reports/rel_satisfacao.php" data-original-title=' Satisfaction' target="_blank">
                                                <i class="fa fa-angle-right"></i>
