                    ...
                    <div class="row">
                      <ul class="col-sm-2 list-unstyled menu1" style="width:180px;">
                       <li>
                        ...
                        <li><a href="./reports/rel_sint.php" target="iframe1" > <?php echo __('Summary','dashboard'); ?> </a></li> 
                        ...
                        <li><a href="./reports/rel_localidades.php?con=1" target="iframe1" > <?php echo __('Location'); ?> </a></li>
                        ...
                        <li><a href="./reports/rel_tarefa.php" target="iframe1" > <?php echo _sn('Task','Tasks',2)." - ". __('Technician'); ?> </a></li>
                        <li><a href="./reports/rel_tarefa_cham.php" target="iframe1" > <?php echo _sn('Task','Tasks',2)." - ". __('Tickets','dashboard'); ?> </a></li>                                                
                      </ul>
