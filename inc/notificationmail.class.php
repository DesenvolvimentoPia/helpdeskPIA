...
class NotificationMail implements NotificationInterface {
   ...
   **/
   ...
   static function testNotification() {
      ...
      $mmail->Subject = "[Suporte] ".__('Mail test');
   ...
   **/
   function sendNotification($options=array()) {
      ...
      $m['subject'] = str_replace("GLPI", "Suporte - TI", $options['subject']);  
      $m['to'] = $options['to'];

      $m['message'] = $options['content_html'];

      $m['headers'] = implode("\r\n",array(
                  'From: Suporte - TI<suporte@pia.com.br>',
                  'Reply-To: Suporte - TI<suporte@pia.com.br>',
                  'Mime-Version: 1.0',
