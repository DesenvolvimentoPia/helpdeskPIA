...
//          $toadd['_no_notif'] = true;
   ...
   **/
   function showFormHelpdesk($ID, $ticket_template=false) {
      ...
      if (!$tt->isHiddenField('locations_id')) {
         echo "<tr style='display:none' class='tab_bg_1'><td>";
...
//       "<div id='uploadfiles'><input type='file' name='filename[]' value='' size='60'></div>";
      ...
      if (!$ticket_template) {
         ...
         echo "<input type='submit' name='add' value='Criar Chamado' class='submit'>";
         echo "</td></tr>";
      }
   ...
   **/
   ...
   function showForm($ID, $options=array()) {
      ...
      if($_SESSION["glpiactiveprofile"]["interface"] == "helpdesk") echo "<tr style='display: none' class='tab_bg_1'>";
      else echo "<tr class='tab_bg_1'>";
      ...
      echo "<td>";
//      $teste = new Profile_User;
      //echo $_SESSION["glpiactiveprofile"]["interface"];
      //print_r($teste);
