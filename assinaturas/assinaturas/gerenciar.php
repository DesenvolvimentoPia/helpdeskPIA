...
$image = imagecreatefromjpeg("../../ti/cron/foto.jpg");
$white = imageColorAllocate($image, 255, 255, 255);
$black = imageColorAllocate($image, 39, 36, 103);
$font = '../../ti/cron/Local Brewery Four.ttf';
imagettftext($image, 40, 0, 30, 80, $black, $font, $_POST['nome']);

if(isset($_POST['filial']) && !empty($_POST['filial']) && $_POST['filial'] != "" && $_POST['filial'] != " ") imagettftext($image, 25, 0, 30, 120, $black, $font, $_POST['setor']." / ".$_POST['filial']);
else imagettftext($image, 25, 0, 30, 120, $black, $font, $_POST['setor']);
...
require_once('../../ti/cron/wideImage/WideImage.php');
...
<style>
	...
	<a href="./" target="_blank" id="mostrarImagens">Ver Assinaturas</a>
